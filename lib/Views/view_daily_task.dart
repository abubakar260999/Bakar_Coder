...
import 'package:triple_n/Views/detailview_daily_task.dart';
...
//                                ||list.status.isEmpty
                ...
                setState(() => daily_task_list[index].status = updated_status as String);
              },
              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    progress_linear_indicator(
                                        daily_task_list[index].status== null
                                            ? ""
                                            : daily_task_list[index].status),
